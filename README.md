# Хакатон Цифриум: прогноз риска отчисления

Репозиторий команды "Три сигма" по ML-кейсу Цифриум: прогноз риска отчисления студентов по LMS-данным и прототип "Светофор" для тьюторов.
...
6. [Initial data schema.md](Initial%20data%20schema.md) - анализ структуры исходных данных.
7. [intermittent_results/](intermittent_results/) - промежуточные черновики и эксперименты без финальной структуры.
